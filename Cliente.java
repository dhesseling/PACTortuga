...
public class Cliente {
	public static void main(String[] args) {
		MarcoCliente mimarco=new MarcoCliente();
                Tortuga[] ListaTortuga = new Tortuga[5];    
	...
	private class EnviaTexto implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            try {
               ...
               /* ObjectInputStream tortuEnt = new ObjectInputStream(miSocket.getInputStream());
                Tortuga tortu = (Tortuga) tortuEnt.readObject();
                Tortuga[] tortugaLista = new Tortuga[5];
                tortugaLista[0]=tortu;
                
                System.out.println("Recibido" + tortugaLista[0]);
                
                ObjectOutputStream tortuSal = new ObjectOutputStream( miSocket.getOutputStream());
                tortuSal.writeObject(tortugaLista[0]);
